...
|  2.3 | Order of transactions included  in a block is modified (due to a bug or malicious intent) | Correct node implementation | Protocol incentive to prevent transaction reordering  |   |  Discuss whether this is a threat |   |
